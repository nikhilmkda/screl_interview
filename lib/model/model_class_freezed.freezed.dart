...
part of 'model_class_freezed.dart';
...
class _$TemperaturesImpl implements _Temperatures {
  ...
  @override
  String toString() {
    return 'Temperatures(id: $id, name: $name, username: $username, email: $email, address: $address, phone: $phone, website: $website, company: $company)';
  }
...
abstract class _Temperatures implements Temperatures {
  const factory _Temperatures(
      ...
      required final Company company}) = _$TemperaturesImpl;
